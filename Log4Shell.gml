graph [
  ...
  node [
    id 6
    label "infrastructure#network#161"
    type "network"
    nlp "remote infrastructure"
    regex ""
    contraction ""
  ]
  node [
  ...
  node [
    ...
    type "vulnerability"
    nlp "exploit"
    regex "CVE-2021-44228 CVE-2022-24348"
    contraction ""
  ]
  node [
    id 10
  ...
  node [
    id 13
    label "malware#executable#361"
    type "executable"
    nlp "malware executables"
    regex ""
    contraction ""
  ]
  node [
